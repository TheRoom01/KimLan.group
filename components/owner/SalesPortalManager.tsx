...
type PortalLink = { id: string; label: string; public_token: string | null; expires_at: string | null; revoked_at: string | null; last_accessed_at: string | null; created_at: string };

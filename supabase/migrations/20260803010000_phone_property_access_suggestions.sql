...
revoke all on function public.request_my_phone_property_access_v1(uuid, text) from public, anon;
grant execute on function public.get_my_phone_property_suggestions_v1() to authenticated, service_role;
grant execute on function public.request_my_phone_property_access_v1(uuid, text) to authenticated, service_role;
